    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE "clients" (
                ...
                "creditScore" integer CHECK (credit_score >= 300 AND credit_score <= 850),
                "employmentYears" decimal(3,1) CHECK (employment_years >= 0),
                "monthlyIncome" decimal(10,2),
                "debtToIncomeRatio" decimal(3,2) CHECK (debt_to_income_ratio >= 0 AND debt_to_income_ratio <= 1),
                "notes" text,
                "isActive" boolean NOT NULL DEFAULT true,
                "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
                "updatedAt" TIMESTAMP NOT NULL DEFAULT now()
        ...
        await queryRunner.query(`
            CREATE TABLE "loan_configurations" (
                ...
                "description" text,
                "baseInterestRate" decimal(5,4) NOT NULL CHECK (base_interest_rate >= 0 AND base_interest_rate <= 1),
                "minPrincipal" decimal(10,2) NOT NULL CHECK (min_principal > 0),
                "maxPrincipal" decimal(10,2) NOT NULL CHECK (max_principal > min_principal),
                "minTermMonths" integer NOT NULL CHECK (min_term_months > 0),
                "maxTermMonths" integer NOT NULL CHECK (max_term_months >= min_term_months),
        ...
        await queryRunner.query(`
            CREATE TABLE "loans" (
                ...
                "interestRate" decimal(5,4) NOT NULL CHECK (interest_rate >= 0 AND interest_rate <= 1),
                "termInMonths" integer NOT NULL CHECK (term_in_months > 0),
        ...
        await queryRunner.query(`
            CREATE TABLE "loan_installments" (
                ...
                "installmentNumber" integer NOT NULL CHECK (installment_number > 0),
                "principalAmount" decimal(10,2) NOT NULL,
                "interestAmount" decimal(10,2) NOT NULL,
                "totalAmount" decimal(10,2) NOT NULL,
                "remainingBalance" decimal(10,2) NOT NULL CHECK (remaining_balance >= 0),
