...
export class LoansController {
  ...
  @ApiOperation({ 
    ...
    description: 'Creates a new loan application with calculated payment details and amortization schedule'
  })
  ...
  @ApiOperation({ 
    ...
    description: 'Provides comprehensive loan statistics including totals, averages, and distribution by status and type'
  })
  @ApiQuery({ 
    name: 'loanOfficerId', 
    required: false, 
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieves detailed loan information including client data and installment schedule'
  })
...
export class LoanCalculationsController {
  ...
  @ApiOperation({ 
    ...
    description: 'Performs loan calculations including monthly payments, amortization schedule, and total costs'
  })
  ...
  async calculateEarlyPayoff(@Body() calculationDto: EarlyPayoffCalculationDto): Promise<EarlyPayoffResultDto> {
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        totalInterest: { type: 'number', example: 233138.40 },
        schedule: {
          type: 'array',
          items: {
            type: 'object',
